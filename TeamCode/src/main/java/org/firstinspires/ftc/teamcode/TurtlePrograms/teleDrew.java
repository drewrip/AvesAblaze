...
public class Tele-op_Template extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            //All your nice fancy codies go here
            if(gamepad1.left_stick_y > 0.07){
              leftMotor.setPower(1);
            }
            else if(gamepad1.left_stick_y < -0.07){
              leftMotor.setPower(-1);
            }
            else{
            ...
            if(gamepad1.right_stick_y >0.07){
              rightMotor.setPower(1);
            }
            else if(gamepad1.right_stick_y < -0.07){
              rightMotor.setPower(-1);
            }
            else{
