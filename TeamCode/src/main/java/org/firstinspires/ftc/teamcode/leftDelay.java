...
@Autonomous(name="leftDelay", group="Pushbot")

public class leftDelay extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        startPositionR = robot.rightMotor.getCurrentPosition();
        while (opModeIsActive() && (robot.rightMotor.getCurrentPosition() < startPositionR + 4450)) {
